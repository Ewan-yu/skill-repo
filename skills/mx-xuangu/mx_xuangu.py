...
def main():
    ...
    parser.add_argument('--output-dir', dest='output_dir', help='输出目录，默认 F:/Source/妙想Skills/mx')
    ...
    # Default output directory is fixed to F:/Source/妙想Skills/mx
    default_output = Path("F:/Source/妙想Skills/mx")
